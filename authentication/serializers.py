...
class LoginSerializer(serializers.Serializer):
    ...
    town = serializers.CharField(max_length=255, read_only=True)
    date_of_birth = serializers.DateField(required=False, allow_null=True)  # Facultatif
    country_code = serializers.DateField(required=False, allow_null=True)
